...
export default function MahjongClient() {
  ...
  const emitTemporaryEndRound = () => {
    ...
    console.log("[ws] emit mahjong:temporary_end_round", { roomId: String(roomId) });
    socket.emit("mahjong:temporary_end_round", { roomId: String(roomId) });
  };
    ...
    >
      ...
      <div className="mt-4 flex items-center justify-center">
        <button
          type="button"
          onClick={onStart}
          className="rounded-full bg-amber-100/90 px-6 py-2 text-sm font-extrabold text-[#3b0500] hover:bg-amber-100"
        >
          Start
        </button>
      </div>
